        ...
        <div class="row gutter-y-60">
                ...
                <aside class="product__sidebar" style="margin-top: 0;">
                    <div class="product__categories product__sidebar__item" >
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="urunkategori/<?php echo seo($kategori['baslik']) ?>/<?php echo $kategori['id'] ?>" data-text="<?php echo $kategori['baslik'] ?>"><span><?php echo $kategori['baslik'] ?></span></a></li>
                            <?php } ?>
                        </ul>
                    </div><!-- /.category-widget -->
                </aside><!-- /.shop-sidebar -->
            ...
            <div class="col-xl-9 col-lg-8">
                ...
                <div class="row gutter-y-30">
                    ...
                    <?php
                    $firstKategori=$db->prepare('select * from urun_kategori  where dilkod=:dilkod order by sira  desc limit 1 ');
                    $firstKategori -> execute(array('dilkod'=>$selectedLanguage));
                    $result = $firstKategori -> fetch();
//                    echo $result['id'];
                    $sayfada = 24;
                    $sorgu = $db->prepare('select * from urun where ust_id=:ust_id and dilkod=:dilkod order by sira desc');
                    $sorgu->execute(array(
                            'ust_id' => $result['id'],
                    ...
                    $hizmetsor = $db->prepare("SELECT * from urun where ust_id=:ust_id and dilkod=:dilkod order by sira desc limit  $limit1 ,$sayfada  ");
