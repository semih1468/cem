...
<section class="page-header">
    ...
    <div class="container">
        <h2 class="page-header__title"><?php echo $ceviri['projelerimiz']?></h2>
        <ul class="floens-breadcrumb list-unstyled">
            <li><i class="icon-home"></i> <a href="anasayfa"><?php echo $ceviri['anasayfa']?></a></li>
            <li><span><?php echo $ceviri['projelerimiz']?></span></li>
...
<section class="blog-page section-space">
    <div class="container">
        <div class="row gutter-y-30">
            ...
            $sayfada = 6;
            $sorgu = $db->prepare('select * from ozellik where dilkod=:dilkod order by ozellik_sira desc');
            ...
            $hizmetsor = $db->prepare("SELECT * from ozellik where dilkod=:dilkod order by ozellik_sira asc limit  $limit1 ,$sayfada  ");
...
"
                        >
                            <img style="height: 150px;object-fit: contain"
                                 src="upload/ozellik/<?php echo $blogcek['ozellik_resim'] ?>"
                                 alt="<?php echo $blogcek['ozellik_baslik'] ?>">
                            <a href="proje/<?php echo seo($blogcek['ozellik_baslik']) ?>/<?php echo $blogcek['ozellik_id'] ?>"
                               class="blog-card__image__link"><span class="sr-only"> <?php echo mb_substr($blogcek['ozellik_baslik'], 0, 50) ?></span>
                                <!-- /.sr-only --></a>
                        </div><!-- /.blog-card__image -->
                        <div class="blog-card__content">
                            <h3 class="blog-card__title mt-4"><a
                                    href="proje/<?php echo seo($blogcek['ozellik_baslik']) ?>/<?php echo $blogcek['ozellik_id'] ?>">
                                    <?php echo mb_substr($blogcek['ozellik_baslik'], 0, 50) ?></a></h3>
                            <!-- /.blog-card__title -->
