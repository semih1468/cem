        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left" action="islem/islem.php" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="ayar_wptell" value="">
                    <input type="hidden" name="ayar_tell" value="">
                    <input type="hidden" name="ayar_gsm" value="">
                    <input type="hidden" name="ayar_keywords" value="">
                    <input type="hidden" name="ayar_googleanalytics" value="">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="middle-name" class="form-control col-md-7 col-xs-12" type="file" name="ayar_logo">
                        </div>
                    </div>
                    <div class="form-group">
