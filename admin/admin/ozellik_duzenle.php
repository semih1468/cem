        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form  method="POST" data-parsley-validate class="form-horizontal form-label-left" action="islem/islem.php" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="dilkod"
                                ...
                                foreach ($diller as $dil) {
                                    if ($dil['code'] == $ozellikbitir['dilkod']) {
                                        echo '
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> Sayfa Başlık
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> Sayfa Sıra
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> Sayfa Resim<br><small>Genişlik:97xYükseklik:97</small>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group" align="center">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> Sayfa İçerik
                        </label>
